    ...
    return (
      <div className="relative w-full">
        ...
        <input
          ...
          onKeyDown={(e) => {
            if (e.key === "Enter") {
              handleSearchPage(searchInput); // Ensure handleSearchPage is called on "Enter"
            }
          }}
        />
          ...
          <AnimatePresence>
            {searchInput && searchResults.length > 0 && (
              ...
              >
                ...
                <Link
                  href={`/feed/search?query=${searchInput}`}
                  className="px-4 py-1 hover:bg-zinc-100 duration-100 ease-linear"
                >
